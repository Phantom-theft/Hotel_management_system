...
import { GuestAvailabilityCalendar } from '../../components/guest/GuestAvailabilityCalendar'
import { RatingBadge, StarRating } from '../../components/ui/StarRating'
import { useGuestRoomAvailability } from '../../hooks/guest/useGuestRoomAvailability'
import { useAuthStore } from '../../store/authStore'
import { useBookingFlowStore } from '../../store/bookingFlowStore'
import { GUEST_ROOMS_LIST_PATH } from '../../utils/guest/guestRoomsPaths'
...
export function GuestRoomDetailPage() {
  ...
  const listPath = GUEST_ROOMS_LIST_PATH
  ...
  const availability = useGuestRoomAvailability(id, calendarMonth)
      ...
      <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr]">
        ...
        <aside className="space-y-4">
          ...
          {availability.isLoading ? (
            ...
            <GuestAvailabilityCalendar bookedDates={availability.data ?? []} month={calendarMonth} />
          )}
        </aside>
      </div>
