...
import { StaffDashboardCard, StaffDashboardStatCard } from '../../components/staff/StaffDashboardCards'
...
export function StaffDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <StaffDashboardCard title="Room status board" description="Live floor-by-floor availability">
...
function StaffTodayCard({
  ...
  return (
    <StaffDashboardCard title={title}>
