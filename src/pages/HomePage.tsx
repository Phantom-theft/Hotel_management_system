...
export function HomePage() {
  ...
  return (
    <div className="relative left-1/2 -mt-8 w-screen max-w-[100vw] -translate-x-1/2">
      {/* Hero — full viewport width & height below navbar */}
      <section className="relative min-h-[calc(100dvh-4.5rem)] overflow-hidden">
        ...
        <div
          ...
          aria-hidden
        />
        <div className="relative mx-auto flex min-h-[calc(100dvh-4.5rem)] max-w-6xl flex-col justify-end px-4 pb-16 pt-20 sm:pb-20 sm:pt-24">
