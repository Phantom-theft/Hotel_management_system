...
import { guestRoomDetailPath } from '../../utils/guest/guestRoomsPaths'
...
export function GuestRoomCard({ room, checkIn, checkOut, guests }: GuestRoomCardProps) {
  ...
  return (
    <article className="group overflow-hidden rounded-xl border border-neutral-100 bg-white shadow-card transition hover:-translate-y-0.5 hover:shadow-card-hover">
      ...
      <div className="space-y-3 p-4 sm:p-5">
        ...
        <Link
          to={guestRoomDetailPath(room.id, qs)}
