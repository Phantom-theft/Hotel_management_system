...
export function StaffDashboardSidebar() {
  ...
  const { sidebarOpen, setSidebarOpen } = useStaffDashboardShell()
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col bg-primary text-white">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4" aria-label="Staff dashboard">
        {STAFF_DASHBOARD_NAV.map((item) => {
...
export function useCloseStaffSidebarOnNavigate() {
