...
import { dashboardShowsDateRange, dashboardTitleForPath } from '../../constants/dashboardNav'
import { useDashboardShell } from '../../contexts/DashboardShellContext'

export function DashboardTopBar() {
  const { pathname } = useLocation()
  const { dateRange, setDateRange, setSidebarOpen } = useDashboardShell()
  const title = dashboardTitleForPath(pathname)
  const showDateRange = dashboardShowsDateRange(pathname)
